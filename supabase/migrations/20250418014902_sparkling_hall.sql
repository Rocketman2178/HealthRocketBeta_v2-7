/*
  # Fix Contest Credit Registration Logic

  1. Changes
    - Improve the should_use_credits_for_contest function to properly check credits
    - Fix the register_contest_with_credits function to handle registration correctly
    - Add detailed logging for credit usage
    - Ensure Clay's user has exactly 1 credit
...
BEGIN
  ...
  -- For paid contests, always use credits if available (regardless of plan)
  RETURN jsonb_build_object(
    'success', true,
