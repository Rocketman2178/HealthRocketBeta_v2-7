/*
  # Fix Contest Registration Check Functions

  1. Changes
    - Drop and recreate the is_user_registered_for_contest function with proper parameter names
    - Update check_contest_eligibility_credits to use the fixed function
    - Update register_for_contest_with_credits to use the fixed function
    - Clean up any existing registrations for Clay's account
