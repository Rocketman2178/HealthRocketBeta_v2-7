/*
  # Fix Sleep Boost Completion Function

  1. Changes
    - Fix the complete_boost function to properly return result data
    - Ensure the function works for all boost categories including sleep
    - Add proper RETURNS clause to avoid "query has no destination for result data" error
