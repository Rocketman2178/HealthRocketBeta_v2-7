/*
  ...
  1. Changes
    ...
    - Create a function to get contest days information
...
INSERT INTO public.boost_processing_logs (
  ...
  0,
  jsonb_build_object(
    'operation', 'fix_contest_days_display',
    'description', 'Added functions to properly calculate and display days until contest start',
    'timestamp', now()
  )
);