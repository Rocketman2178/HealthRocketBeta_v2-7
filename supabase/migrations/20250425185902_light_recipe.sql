/*
  # Remove Special Boost Handling for Contests

  1. Changes
    - Remove special boost handling for Contests in database functions
    - Update contest requirements to focus only on verification posts
    - Remove boost count tracking from active_contests and challenges tables
